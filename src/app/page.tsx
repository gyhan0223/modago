  ...
  return (
    <main className="bg-white text-gray-900">
      ...
      <div className="relative overflow-hidden">
        <section
          className="relative min-h-[100vh] flex flex-col items-center justify-center px-6"
        >
          ...
          <div className="relative z-30 w-full max-w-6xl mx-auto text-left text-white">
            ...
            >
              hongdae flagship art institute
            </motion.p>
            <motion.h1
            ...
            >
              1989년 홍대 앞 작은 작업실에서 시작해 지금까지, 학생의 개성이
              그대로 드러나는 포트폴리오로 수많은 합격 스토리를 만들어왔습니다.
              모두가 같은 답을 찾지 않아도, 각자의 언어로 미술을 말하도록 돕는
              것이 우리의 방식입니다.
            </motion.p>
            <motion.div
      ...
      >
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          >
            ...
            미대 입시부터 유학 포트폴리오까지, 목표에 맞춘 맞춤 지도를 진행합니다.
          </motion.p>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-24">
        <div className="max-w-6xl mx-auto px-6 grid gap-6 md:grid-cols-3">
          {["개인 맞춤 지도", "실전 기반 피드백", "입시/유학 연계"].map((title, idx) => (
            <motion.article
              key={title}
              {...fadeUp}
        ...
        <div className="max-w-6xl mx-auto grid gap-14 px-6 md:grid-cols-[1.1fr_0.9fr] md:items-center">
          ...
          >
            ...
            <p className="text-lg leading-relaxed text-gray-600">
              모두다른고양이는 학생 개개인의 흥미와 감각을 존중하는 스튜디오형 학습
              환경을 지향합니다. 작업실 곳곳에 설치된 참고 라이브러리, 주제에 따라
              변화하는 쇼케이스 전시, 주간 크리틱 모임으로 서로의 작업을 나누며
              폭넓은 미감과 표현을 탐구할 수 있습니다.
            </p>
            <ul className="space-y-4 text-gray-700">
              <li className="flex items-start gap-3">
                <span className="mt-1 inline-flex h-2 w-2 rounded-full bg-brand" />
                <span>
                  기초 드로잉부터 전공 심화, 미디어아트, 아트디렉션까지 세분화된 트랙을
                  통해 목표에 맞게 선택 수강합니다.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-1 inline-flex h-2 w-2 rounded-full bg-brand" />
                <span>
                  전임 강사진의 피드백과 실기 모의 평가를 통해 작업 과정 전반을 다각도로
                  점검합니다.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-1 inline-flex h-2 w-2 rounded-full bg-brand" />
                <span>
                  졸업생 네트워크와 연계한 전시, 작가 특강, 진로 상담으로 대학 입학 이후의
                  활동까지 함께 설계합니다.
                </span>
              </li>
            </ul>
      ...
      <section id="program" className="bg-gray-900 py-28 text-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            학생의 기초 실력, 지원 학교, 진로 계획을 분석해 4단계 로드맵을 제시합니다.
            각 단계는 포트폴리오 기획, 테크닉 훈련, 실전 모의, 프리젠테이션 준비로 구성됩니다.
          </motion.p>
            ...
            {[
              ...
              >
                <div>
                  ...
                  <p className="mt-4 text-base text-white/70">{item.description}</p>
                </div>
                <div className="mt-6 text-sm text-white/40">주 4회 수업 · 담임제 피드백</div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section id="teachers" className="bg-white py-28">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            홍익대학교, 국민대학교, 서울대학교 등 주요 미대 출신 강사진이 함께하며 입시 실전 경험과
            현역 작가로서의 감각을 동시에 전달합니다. 주 1회 이상 진행되는 멘토링 세션으로 학생의
            진로와 작업 방향을 구체화합니다.
          </motion.p>
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-baseline justify-between">
                    <h3 className="text-2xl font-semibold text-gray-900">{teacher.name}</h3>
                    <span className="text-sm uppercase tracking-[0.35em] text-gray-300">
                      mentor
                    </span>
                  </div>
                  <p className="mt-2 text-sm font-medium text-brand">{teacher.role}</p>
