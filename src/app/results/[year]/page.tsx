    ...
    <main className="min-h-screen bg-white text-gray-900">
      <header className="relative overflow-hidden bg-gradient-to-br from-amber-50 via-white to-white">
        ...
        <div className="absolute inset-x-0 top-8 z-10 flex justify-center">
          <Link
            href="/"
            className="relative z-20 inline-flex items-center gap-2 rounded-full border border-amber-200/70 bg-white/80 px-4 py-2 text-sm font-medium text-amber-600 shadow-sm backdrop-blur transition hover:bg-white"
          >
            ← 홈으로 돌아가기
          </Link>
        </div>
